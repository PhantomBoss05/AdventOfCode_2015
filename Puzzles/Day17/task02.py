...
small_valid_combinations: int = 100
temp_list: list[int] = []
...
for combination in possibilities_int:
    if sum(combination) == 150:
        if len(combination) < small_valid_combinations:
            valid_combinations = []
            small_valid_combinations = len(combination)
            valid_combinations.append(combination)
        elif len(combination) == small_valid_combinations:
            valid_combinations.append(combination)
