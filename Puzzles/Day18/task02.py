            ...
            match light:
                ...
                case 0:
                    ...
                    if x < array_range-1:
                        ...
                        y += 1
                        x = 0
    new_lightmap[0][0], new_lightmap[0][array_range-1], new_lightmap[array_range-1][0], new_lightmap[array_range-1][array_range-1] = 1,1,1,1
    lightmap = new_lightmap
    new_lightmap = np.zeros((array_range, array_range), dtype=int)


print(np.sum(lightmap)) #886
